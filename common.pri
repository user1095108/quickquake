...
CONFIG += exceptions no_lflags_merge rtti_off stl thread warn_on
CONFIG -= c++11 c++14 rtti
...
*-g++* {
  ...
  QMAKE_CXXFLAGS = -std=c++2a -Wall -Wextra -Wno-missing-field-initializers -Wno-multichar -fno-stack-protector -fno-plt -no-pie
